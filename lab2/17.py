# 17. Korišdenjem programskog jezika Python, napisati funkciju tekst, koja karaktere u tekstu koji su van
...
def tekst(tekstt):
    ...
    final_list = [karakter if (65 <= ord(karakter) <= 90) or (97 <= ord(karakter) <= 122) or (48 <= ord(karakter) <= 57)
                 else "\\u" + hex(ord(karakter))[2:].upper().zfill(4) for karakter in tekstt]
